      ...
      try {
        if (userId) {
          ...
          if (conversationId) {
            ...
            logger.info(
              `[ImageGenOAI] Successfully charged ${FIXED_SERVICE_COSTS.FLUX_IMAGE} image tokens`,
            );
          } else {
        ...
        try {
          if (userId) {
            ...
            if (conversationId) {
              ...
              logger.info(
                `[ImageEditOAI] Successfully charged ${FIXED_SERVICE_COSTS.FLUX_IMAGE} image tokens`,
              );
            } else {
