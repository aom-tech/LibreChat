...
export function getSubscriptionPlans(): Promise<{ plans: Record<string, SubscriptionPlan> }> {
  return request.get('/api/subscription/plans');
}

export function getSubscriptionStatus(): Promise<{ subscription: SubscriptionStatus }> {
  return request.get('/api/subscription/status');
}

export function createCheckoutSession(data: { tier: string }): Promise<{ session: CheckoutSession }> {
  return request.post('/api/subscription/checkout', data);
}

export function cancelSubscription(): Promise<{ message: string; subscription: SubscriptionStatus }> {
  return request.post('/api/subscription/cancel');
}

export function activateSubscription(data: { tier: string }): Promise<{ message: string; subscription: SubscriptionStatus }> {
  return request.post('/api/subscription/activate', data);
}
